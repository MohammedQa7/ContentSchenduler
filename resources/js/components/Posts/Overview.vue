                        ...
                        <div v-for="platform in platforms" :key="platform.name" class="space-y-2">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <div class="text-center p-3 rounded-lg bg-orange-50 border border-orange-200">
                                    <div class="text-lg font-semibold text-orange-700">{{ platform.scheduled }}
                                    </div>
                            ...
                            <div class="flex space-x-1 h-2">
                                <div class="bg-green-500 rounded-l"
                                    :style="{ width: `${(platform.published / platform.posts) * 100}%` }"></div>
                                <div class="bg-orange-500 rounded-r"
                                    :style="{ width: `${(platform.scheduled / platform.posts) * 100}%` }"></div>
                            </div>
                        </div>
                    </div>
                </div>
